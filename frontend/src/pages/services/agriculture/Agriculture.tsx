        ...
        <ContactContainer>
          ...
          <form>
            ...
            <FormGroup>
              ...
              <CheckboxContainer>
                <CheckboxGroup>
                  <FormCheckbox type="checkbox" id="solar" />
                  <CheckboxLabel htmlFor="solar">Solar</CheckboxLabel>
                </CheckboxGroup>
                
                <CheckboxGroup>
                  <FormCheckbox type="checkbox" id="roofing" />
                  <CheckboxLabel htmlFor="roofing">Roofing</CheckboxLabel>
                </CheckboxGroup>
                
                <CheckboxGroup>
                  <FormCheckbox type="checkbox" id="landscape" />
                  <CheckboxLabel htmlFor="landscape">Landscape</CheckboxLabel>
                </CheckboxGroup>
              </CheckboxContainer>
            </FormGroup>
